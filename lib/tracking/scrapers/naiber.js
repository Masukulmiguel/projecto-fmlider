...
export async function trackNaiber(value) {
  ...
  try {
    ...
    await page.goto('http://pslnavegacao.com/tracking.html', { waitUntil: 'networkidle2', timeout: 30000 });
    await page.waitForSelector('input[type="text"], input[name*="tracking"]', { timeout: 10000 });
    const inputSelector = 'input[type="text"], input[name*="tracking"]';
