...
-- ============================================================
-- RLS disabled: frontend handles auth via Supabase Auth + JWT.
-- All queries use the anon key with auth checks in application code.

-- (RLS intentionally not enabled — avoids uuid/bigint type mismatches)
