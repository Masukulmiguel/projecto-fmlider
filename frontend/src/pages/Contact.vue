<template>
  <div class="contact-page py-5">
    <div class="container">
      <h1 class="mb-5">{{ t('contact.page_title') }}</h1>
      <div class="row">
        <div class="col-lg-6">
          <div class="contact-info">
            <div class="info-item mb-4">
              <h5>{{ t('contact.info_phone') }}</h5>
              <p>+244 935141747</p>
            </div>
            <div class="info-item mb-4">
              <h5>{{ t('contact.info_email') }}</h5>
              <p>geral@fmlider.co.ao</p>
            </div>
            <div class="info-item mb-4">
              <h5>{{ t('contact.info_address') }}</h5>
              <p>{{ t('contact.info_address_text') }}</p>
            </div>
          </div>
          <div class="mt-4">
            <h5>{{ t('contact.map_heading') }}</h5>
            ...
            <a href="https://www.google.com/maps/place/FMLider+-+Base/@-8.7693538,13.3973228,359m/data=!3m1!1e3!4m6!3m5!1s0x1a51e5684ed42f1b:0x5630ab6f53efd403!8m2!3d-8.769266!4d13.3984122"
              ...
              <i class="bi bi-geo-alt-fill me-1"></i> {{ t('contact.map_cta') }}
            </a>
          </div>
        </div>
        <div class="col-lg-6">
          <form @submit.prevent="submitForm" class="contact-form">
            ...
            <div class="mb-3">
              <label for="company" class="form-label">{{ t('contact.form_company') }}</label>
              <input type="text" class="form-control" id="company" v-model="form.company">
            </div>
            <div class="mb-3">
              <label for="phone" class="form-label">{{ t('contact.form_phone') }}</label>
            ...
            <div class="mb-3">
              <label for="subject" class="form-label">{{ t('contact.form_subject') }}</label>
            ...
            <button type="submit" class="btn btn-primary btn-lg w-100">{{ t('contact.form_submit') }}</button>
          </form>
        </div>
      </div>
    </div>
